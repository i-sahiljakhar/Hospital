...
console.log("CREATE APPOINTMENT DOCTOR ID:", doctorId);
console.log("CREATE APPOINTMENT DATE:", date);
console.log("CREATE APPOINTMENT TIME:", time);
console.log("CREATE APPOINTMENT PATIENT:", patientName);
    ...
    console.log("APPOINTMENT BASE:", base);
   ...
   const cancelUrl = `${frontBase}/appointment/cancel?session_id={CHECKOUT_SESSION_ID}`;
...
export const getAppointmentsByDoctor = async (req, res) => {
  try {
    ...
    const items = await Appointment.find(filter)
      ...
      console.log("APPOINTMENTS FOUND:", items.length);
