...
//this function will remove duplicate slot and return the slot filter by items
...
console.log("BODY:", req.body);
    ...
    if (req.file?.path) {
      ...
      imagePublicId =
        uploaded.public_id || uploaded?.public_id || imagePublicId;
    }
...
// to get doctor by ID ie to fetch on doctor
