...
const ListPage = () => {
  ...
  async function fetchAppointments() {
    ...
    try {
      ...
      // Backend me "appointment" singular aa raha hai
  ...
  async function rescheduleRemote(id, newDate, newTime24) {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(
          body?.message || `Reschedule failed (${res.status})`,
        );
      }
              ...
              >
                <header className={listPageStyles.cardHeader}>
                  <div className={listPageStyles.cardAvatar}>
                    {a.doctorImage ? (
                      ...
                      <div
                        className={
                          listPageStyles.cardAvatarFallback
                        }
                      >
                ...
                <div className={listPageStyles.dateTimeSection}>
                  <div className={listPageStyles.dateTimeContainer}>
                    <Calendar
                      className={listPageStyles.calendarIcon}
                    />
