      ...
      <div className={footerStyles.mainContent}>
            ...
            <div className={footerStyles.contactContainer}>
              <div className={footerStyles.contactItem}>
                <div className={footerStyles.contactIconWrapper}>
                  <PhoneCallIcon className={footerStyles.contactText} />
                </div>
                <span className={footerStyles.contactText}>+91 9897657645</span>
              </div>

              <div className={footerStyles.contactItem}>
                <div className={footerStyles.contactIconWrapper}>
                  <MailIcon className={footerStyles.contactText} />
                </div>
              ...
              <div className={footerStyles.contactItem}>
                <div className={footerStyles.contactIconWrapper}>
                  <MapPinCheckIcon className={footerStyles.contactIcon} />
                </div>
                <span className={footerStyles.contactText}>Palwal,Haryana</span>
              </div>
            </div>
          </div>
                  ...
                  <li key={link.name} className={footerStyles.linkItem}>
                    ...
                    >
                      <div className={footerStyles.quickLinkIconWrapper}>
                        <ArrowRightIcon
                          className={footerStyles.quickLinkIcon}
                        />
                      </div>
          ...
          <div className={footerStyles.linksSection}>
            ...
            <ul className={footerStyles.linksList}>
              {/* {services.map((services, index) => (
                <li key={services._id}>
                  <a href={services.href} className={footerStyles.serviceLink}>
              ...
              {services.map((service, index) => (
                <li key={service._id || `${service.name}-${index}`}>
        ...
        <div className={footerStyles.bottomSection}>
          ...
          <div className={footerStyles.designerText}>
            ...
            <a
              href="https://www.linkedin.com/in/sahil-jakhar015/"
              target="_blank"
          ...
          <div className={footerStyles.designerText}>
            ...
            <a
              href="https://real-estate-seven-orpin.vercel.app/"
              target="_blank"
              className={footerStyles.designerLink}
            >
