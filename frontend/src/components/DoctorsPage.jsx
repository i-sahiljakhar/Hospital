    ...
    <div className={doctorsPageStyles.mainContainer}>
      ...
      <div className={doctorsPageStyles.wrapper}>
        <div className={doctorsPageStyles.headerContainer}>
          <h1 className={doctorsPageStyles.headerContainer}>
            Our Medical Experts
          </h1>
        ...
        {loading ? (
          <div className={doctorsPageStyles.skeletonGrid}>
            {Array.from({ length: 8 }).map((_, i) => (
              ...
              >
                <div
                  className={doctorsPageStyles.skeletonImage}
                ></div>

                <div
                  className={doctorsPageStyles.skeletonName}
                ></div>
          ...
          >
            {displayedDoctors.length > 0 ? (
              ...
              <div
                className={doctorsPageStyles.noResults}
              >
