...
export default function DashboardPage({ apiBase }) {
  ...
  async function fetchAppointments() {
    ...
    try {
      ...
      console.log("DOCTOR DASHBOARD API RESPONSE:", body);

      console.log("API RESPONSE:", body);
console.log("BACKEND APPOINTMENT COUNT:", body?.appointment?.length);
console.log("BACKEND APPOINTMENTS:", body?.appointment);
      ...
      //     console.log("DOCTOR DASHBOARD APPOINTMENTS:", list);
      ...
      console.log("FRONTEND LIST COUNT:", list.length);
console.log("FRONTEND LIST:", list);
