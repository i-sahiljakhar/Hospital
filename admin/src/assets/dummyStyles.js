...
export const navbarStyles = {
  ...
  centerNavScrollContainer: "center-inner relative whitespace-nowrap rounded-3xl bg-white/95 lg:px-2 px-4 py-2 flex items-center gap-2 shadow-lg border border-gray-100 overflow-x-auto scrollbar-hide",
...
//   headerLg:
//     "hidden lg:grid grid-cols-12 items-center gap-4 px-4 py-3 text-sm text-gray-600 bg-emerald-50",
...
//   body: "divide-y divide-emerald-50 min-w-full",

//   // IMPORTANT: every service row will now be one 12-column grid
//   row:
//     "px-4 py-4 font-serif hover:shadow-md transition bg-white md:bg-transparent lg:grid lg:grid-cols-12 lg:items-center lg:gap-4",
...
//   tabletServiceName:
//     "text-sm font-medium text-emerald-800 whitespace-nowrap",
...
//   desktopServiceName:
//     "font-semibold text-lg text-emerald-800 truncate",

//   desktopCell: (span) =>
//     `col-span-${span} min-w-0`,

//   desktopCenterCell: (span) =>
//     `col-span-${span} text-center min-w-0`,
...
//   mobileServiceName:
//     "font-semibold text-xs text-emerald-800",

//   mobileStatsContainer:
//     "mt-2 flex flex-wrap gap-2 text-xs text-gray-600",
